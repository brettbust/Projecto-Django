...
class productos(models.Model):
    nombre_del_producto = models.CharField(
        max_length=20, verbose_name='nombre del producto')
    precio_del_producto = models.FloatField(
...
class pedidos(models.Model):
    ...
    estado_del_pedido = models.CharField(
...
class pacientes(models.Model):
    ...
    nombre = models.CharField(
        max_length=20, verbose_name='nombre del paciente')
    apellido = models.CharField(
        max_length=20, verbose_name='apellido del paciente')
...
class historial(models.Model):
    relacion_con_pacientes = models.ForeignKey(pacientes, on_delete=PROTECT)
    historial_medico = models.CharField(
        max_length=200, verbose_name='historial medico')
